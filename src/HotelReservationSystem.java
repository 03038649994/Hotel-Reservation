...
public class HotelReservationSystem
{
	public static void main (String[] args)
	{
		...
		hotel.addReservation(new Reservation(day1, day2, 0001, hotel.getRooms().get(0)));
		hotel.addReservation(new Reservation(day1, day2, 0002, hotel.getRooms().get(2)));
		hotel.addReservation(new Reservation(day1, day3, 0003, hotel.getRooms().get(3)));
		hotel.addReservation(new Reservation(day1, day2, 0004, hotel.getRooms().get(4)));
