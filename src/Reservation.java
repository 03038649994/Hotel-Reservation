...
public class Reservation implements Serializable, Comparable<Reservation>
{
	 ...
	 */
	public int getPrice() {return room.getRoomCost();}
	...
	{
		return "Room #: " + getRoomNumber() + ", check in: " + dateFormat.format(startDate.getTime())
				+ " check out: " + dateFormat.format(endDate.getTime());
	}
	@Override
	public int compareTo(Reservation other)
	{
		if(getStartDate().after(other.getStartDate())) {return  -1;}
		else {return 1;}
	}
}